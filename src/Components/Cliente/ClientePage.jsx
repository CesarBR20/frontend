...
const ClientePage = () => {
  ...
  const acceptTerms = async () => {
    try {
      await axios.patch("http://35.172.220.219:3000/clients/accept-terms", {}, {
  ...
  const downloadFormat = async () => {
    try {
      const response = await axios.get("http://35.172.220.219:3000/files/download-excel", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
  ...
  const uploadFiles = async () => {
    ...
    try {
      await axios.post("http://35.172.220.219:3000/files/upload", formData, {
        headers: {
  ...
  const processFiles = async () => {
    ...
    try {
      ...
      const processResponse = await axios.post("http://35.172.220.219:3000/files/process-cfdis", {}, {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
  ...
  const fetchTableData = async () => {
    try {
      ...
      const response = await axios.get(`http://35.172.220.219:3000/files/list-cfdis?username=${username}`, {
